...
def get_args_parser():
    ...
    parser.add_argument("--num_queries_one2many", default=300, type=int,
    ...
    parser.add_argument('--use_enc_aux_loss', default=True, action='store_true')
    parser.add_argument('--rho', default='0.6', type=float)
    parser.add_argument("--k_one2many", default=5, type=int)
    parser.add_argument("--lambda_one2many", default=1.0, type=float)
    parser.add_argument("--mixed_selection", action="store_true", default=True)
